...
//Styles
import { ImageBackground, Image, ImageContainer, Left, Right, Wrapper, Background } from './Description.styles';
import { Text } from './Description.styles';

//Images
import heroImage from '../../../images/heroImage(BC).jpg';
     ...
     return (
          <Wrapper>
               <Left>
                    ...
                    <svg width="150" height="150" className='rightSVG' viewBox="0 0 295 648" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <Right>
                    <Background />
                    <Text>PruthaTek maintains a comprehensive, thoughtful process that ensures business continuity and ultimate reliability.</Text>
